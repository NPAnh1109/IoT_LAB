...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"NPAnh/feeds/sensor1", "NPAnh/feeds/sensor2"};

    final String clientId = "12345678";
    final String username = "NPAnh";
    final String password = "aio_zpxX83QkAPysnjLfe5nK3zZKn3BN";
